<template>
  <div
    :id="`${moduleObject.id}-common-header`"
    class="common-header d-flex just-b over-h"
  >
    <div class="common-header-left flex-1 d-flex align-c">
      <div class="d-flex align-c" v-if="propData.isShowLeftIcon">
        <svg v-if="propData.titleIcon && propData.titleIcon.length" class="common-header-left-icon" aria-hidden="true" >
    ...
    >
      ...
      <div class="d-flex align-c" v-if="isShowIcon">
        <svg v-if="propData.rightTitleIcon && propData.rightTitleIcon.length" class="common-header-right-icon" aria-hidden="true" >
...
export default {
  ...
  computed: {
    ...
    isShowBadge() {
      return ["badge", "badgeAndIcon"].includes(
        this.propData.titleRightContent
      );
    },
    isShowIcon() {
      return ["icon", "textAndIcon", "badgeAndIcon"].includes(
        this.propData.titleRightContent
      );
    },
  },
